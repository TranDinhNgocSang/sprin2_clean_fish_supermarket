...
function Login(){
    return(
        <>
      <section className="vh-100 gradient-custom" id="bg-login"
>
              ...
              <div className="card bg-dark1 text-white" style={{borderRadius: '1rem', backgroundColor: "rgba(25, 25, 15, 0.1)!important"}}>
                <div className="card-body p-5 text-center">
                  <div className="mb-md-5 mt-md-4 pb-5">
                    ...
                    <button className="btn btn-outline-light btn-lg px-5" type="submit">Đăng nhập</button>
                  ...
                  <div>
                    <p className="mb-0">Bạn đã có tài khoảng chưa? <a href="#!" style={{color: "white" }}><b>Đăng ký</b></a>
                    </p>
                  </div>
                </div>
              </div>
