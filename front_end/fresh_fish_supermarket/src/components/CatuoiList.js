            ...
            <div className="row">
              <div className="col-lg-3">
                <div className="hero__categories">
                  ...
                  <ul >
                    <li style={{backgroundColor:"rgb(25, 98, 145)"}}><Link to={"/ca-tuoi"} style={{color: "white"}} className = "menu-trang-chu"><b>CÁ TƯƠI TỰ NHIÊN</b></Link></li>
                    <hr className = "menu-trang-chu-hr"></hr>
                    <li><Link to={"/tom-muc"} className = "menu-trang-chu" href="/#">TÔM, BẠC TUỘT, MỰC</Link></li>
                    <hr className = "menu-trang-chu-hr"></hr> 
                    <li><Link to={"/oc-hau"} className = "menu-trang-chu" href="/#">ỐC, HÀU, VẸM CÁC LOẠI</Link></li>
                    <hr className = "menu-trang-chu-hr"></hr>
              ...
              <div className="col-lg-9">
                <div className="hero__item set-bg2">
                  <div className="hero__text">
                    <span>HẢI SẢN SẠCH</span>
                    <h2>Cá tươi<br />Đánh bắt trong ngày</h2>
                  </div>
                </div>
              </div>
            </div>
