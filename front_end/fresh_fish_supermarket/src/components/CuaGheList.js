          ...
          <div className="container">
            <div className="row">
              <div className="col-lg-3">
                <div className="hero__categories">
                  ...
                  <ul >
                    ...
                    <hr className = "menu-trang-chu-hr"></hr>
                    <li style={{backgroundColor:"rgb(25, 98, 145)"}}><Link to={"/cua-ghe"} style={{color: "white"}} className = "menu-trang-chu"><b>CUA-GHẸ</b></Link></li>
              ...
              <div className="col-lg-9">
                ...
                <div className="hero__item set-bg4">
