          ...
          <div className="container">
            <div className="row">
              <div className="col-lg-3">
                <div className="hero__categories">
                  ...
                  <li><Link to={"/ca-tuoi"} className = "menu-trang-chu" href="/#">CÁ TƯƠI TỰ NHIÊN</Link></li>
                    ...
                    <hr className = "menu-trang-chu-hr"></hr>
                    <li style={{backgroundColor:"rgb(25, 98, 145)"}}><Link to={"/hs-dong-lanh "} style={{color: "white"}} className = "menu-trang-chu"><b>HẢI SẢN ĐÔNG LẠNH</b></Link></li>
              ...
              <div className="col-lg-9">
                ...
                <div className="hero__item set-bg6">
...
export default HaiSanDongLanhList;
