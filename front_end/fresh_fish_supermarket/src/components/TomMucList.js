          ...
          <div className="container">
            <div className="row">
              <div className="col-lg-3">
                <div className="hero__categories">
                  ...
                  <ul >
                    ...
                    <li style={{backgroundColor:"rgb(25, 98, 145)"}}><Link to={"/tom-muc"} style={{color: "white"}} className = "menu-trang-chu"><b>TÔM, BẠC TUỘT, MỰC</b></Link></li>
                    <hr className = "menu-trang-chu-hr"></hr>
              ...
              <div className="col-lg-9">
                ...
                <div className="hero__item set-bg7">
                </div>  
              </div>
            </div>
          </div>
